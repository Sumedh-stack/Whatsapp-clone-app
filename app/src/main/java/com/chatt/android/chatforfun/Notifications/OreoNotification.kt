...
private var notificationManager:NotificationManager?=null
    ...
    companion object{
        private const val CHANNEL_ID="com.chatt.android.chatforfun"
    ...
    fun getOreoNotification(title:String?,body:String?,pendingIntent:PendingIntent?,soundUri: Uri?,icon:String? ):Notification.Builder{
        return Notification.Builder(applicationContext, CHANNEL_ID).setContentIntent(pendingIntent).setContentTitle(title).setContentText(body).setSmallIcon(icon!!.toInt()).setSound(soundUri)
    }
}
